...
window.isMobile = function() {
    ...
    if (navigator.userAgentData && navigator.userAgentData.mobile !== undefined) {
        ...
        userAgentCheck = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
    }
...
class DesktopScrollManager {
    ...
    configureMobileSettings() {
        if (isMobile()) {
            ...
            document.body.classList.remove("disable-cursor", "viewport-mobile", "fixed-viewport");
    ...
    updateViewportHeight() {
        if (isMobile()) {
            ...
            document.documentElement.style.setProperty('--dvw', `${window.innerWidth / 100}px`);
        }
    }
